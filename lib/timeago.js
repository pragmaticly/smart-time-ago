  ...
  TimeAgo = (function() {
    ...
    TimeAgo.prototype.distanceOfTimeInWords = function(absolutTime) {
      ...
      if (dim === 0) {
        ...
        return "" + (this.options.approximate ? this.options.lang.prefixes.about + " " : "") + (Math.round(dim / 60)) + space + this.options.lang.units.hours;
        ...
        return "" + (this.options.approximate ? this.options.lang.prefixes.about + " " : "") + (Math.round(dim / 525600)) + space + this.options.lang.units.years;
      }
    };
