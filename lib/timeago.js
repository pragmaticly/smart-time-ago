  ...
  TimeAgo = (function() {
    ...
    TimeAgo.prototype.updateInterval = function() {
      ...
      if (this.$element.findAndSelf(this.options.selector).length > 0) {
        ...
        if (newestTimeInSeconds >= 0 && newestTimeInSeconds < 2700 && this.startInterval !== 60000) {
          this.startInterval = 60000;
          return this.restartTimer();
        } else if (newestTimeInSeconds >= 2700 && newestTimeInSeconds < 5400 && this.startInterval !== 60000 * 22) {
          this.startInterval = 60000 * 22;
          return this.restartTimer();
        } else if (newestTimeInSeconds >= 5400 && newestTimeInSeconds < 151200 && this.startInterval !== 60000 * 30) {
          this.startInterval = 60000 * 30;
          return this.restartTimer();
        } else if (newestTimeInSeconds >= 151200 && this.startInterval !== 60000 * 60 * 12) {
